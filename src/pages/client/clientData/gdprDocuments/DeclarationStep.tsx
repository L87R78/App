...
import { classes } from './styles'; // Import Tailwind class mappings

const DeclarationStep = ({ onNext, onBack }: { onNext: () => void; onBack: () => void }) => {
  ...
  const handleSaveAndContinue = () => {
    console.log('Saving and continuing to next GDPR tab');
    onNext();
  };
